<footer class="footerBckg container-fluid">
	<div class="container footerBg">
		<div class="firstRow row">
			<ul class="col-md-12">
				...
				<li class="col-md-3 footerNavigation"><span class="footerTitle">Policies</span>
					<ul><li><a href="termsAndCondition.php">Terms &amp; Condition</a></li></ul>
				</li>
				<li class="col-md-3">
					<ul>
						<li class="text-right">
							<a href="https://twitter.com/gbennettilife" target="_blank"> <i class="fa fa-twitter-square"></i> </a>
							<a href="https://www.facebook.com/gbennettilife/" target="_blank"> <i class="fa fa-facebook-square"></i> </a>
							<a href="https://plus.google.com/u/2/114115452834607783382" target="_blank"> <i class="fa fa-google-plus-square"></i> </a>
							<a href="https://in.linkedin.com/in/gbennetti-life" target="_blank"> <i class="fa fa-linkedin-square"></i> </a>
						</li>
						<li class="text-right">
		...
		<!-- End firstRow -->
		<div class="text-center copyrights"> <small>All rights reserved, copyright &copy; 2017. GBennetti Biolabs (P) Ltd. </small> </div>
	</div>
</footer>
<div id="toggleItems">
		...
		<form name="ChronoContact_newsletter_home" id="ChronoContact_newsletter_home" method="POST" action="controller.php">
			...
			<div class="form_item">
				<div class="form_element cf_textbox">
					...
					<input class="cf_inputbox required validate-email" maxlength="150" size="30" title="" id="email_add" name="email_add" type="text" style="color:#000" value="Enter email address" onfocus="if(this.value == 'Enter email address') { this.value = ''; }" onblur="if(this.value == '') { this.value = 'Enter email address'; }"> </div>
				<div class="cfclear"></div>
			</div>
			<div class="form_item">
				<div class="form_element cf_button">
					<input value="Submit" name="letter_head" type="submit" onclick="giveMessage()"> </div>
				<div class="cfclear"></div>
			</div>
		</form>
	</div>
