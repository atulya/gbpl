...
<?php include "usp.php"; ?>
<a href="global-network.php" class="pull-right">Next - International Business<i class="glyphicon glyphicon-chevron-right"></i></a>
    </div>
  </div>
</div>
