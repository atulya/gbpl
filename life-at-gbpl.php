...
<html lang="en">
  ...
  <body>
    ...
    <div class="innerpageBanner animated flipInX bannerimg-lifegbpl">
...
<?php include "usp.php"; ?>
<a href="culture.php" class="pull-right">Next - Career<i class="glyphicon glyphicon-chevron-right"></i></a>
        </div>
      </div>
    </div>
