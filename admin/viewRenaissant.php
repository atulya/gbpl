...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Renaissant</h1>
        </div>
    </div><!--/.row-->
...
INNER JOIN tbl_left AS l ON l.id = s.left_id WHERE l.root_id = 2 AND d.status = 0");
    $statement->execute();
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading">List Renaissant</div>
                    ...
                    <table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                        ...
                        <tbody>
                            ...
                            <tr>
								...
								<td><a href="addRenaissant.php?data_id=<?php echo $row['id']; ?>">Update</a> | <a href="#" onclick="askPermission(<?php echo $row['id']; ?>)">Delete</a></td>
                            </tr>
                            <?php } } ?>
                        </tbody>
                    </table>
...
<script>
	function askPermission(id){
		if(confirm("Are you sure?")){
			window.location.href = "deleteController.php?type=data&page=3&id="+id;
		}
	}
</script>
