      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h3>
            Multi-faceted, Research oriented &amp; globally integrated healthcare organization 
            </h3>
          </div>
        </div>
      </div>
      ...
      <div class="row innerContent">
        ...
        <h3>Corporate Snap Shot</h3>
          <p>
            ...
            <li>
            Fast growing company with presence in 5+ continents, 20+ countries, and 350+ products</li>
            <li>
