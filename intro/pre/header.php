		...
		<ul class="nav nav-pills pull-right">
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href="aboutus.php">Corporate Overview</a></li>
					<li><a href="snap-shot.php">Snap Shot</a></li>
			...
			<li class="dropdown">
				<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">We Care<span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="social-responsiblity.php">Community Care</a></li>
					</ul>
			</li>
		</ul>
</div>
<div class="col-md-2 text-center">
	<a href="javascript:void(0);"><img src="images/weblogo.png" height="100px" alt="gbpl logo"></a>
</div>
<div class="col-md-5">
<ul class="nav nav-pills">
	...
	<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">We offer <span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="renaissant-hebe.php">Renaissant</a></li>
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu">
			<li>
				<a href="global-network.php">Global network</a>
			</li>
			<li>
	...
	<li class="dropdown">
		<a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">We manifest<span class="caret"></span></a>
		<ul class="dropdown-menu">
