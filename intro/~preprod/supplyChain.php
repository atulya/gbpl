...
<html lang="en">
  ...
  <body>
    ...
    <div class="innerpageBanner">
      <img src="images/SupplyChain.jpg" alt="Supply Chain">
      <div class="container">
        <div class="row">
    ...
    <div class="container">
      ...
      <div class="col-md-3">
        ...
        <div class="col-md-8">
          ...
          <p>
          <blockquote>
            <h3>“First Class On Site-On Time Delivery, Always”.</h3>
            </blockquote>
           
            This is the global mandate on which GBennetti global distribution and supply chain operates. Wholenetwork is built around flexibility, responsiveness and reliability and oscillates between the supply paradigm of stock-based model and Just- in- Time model depending upon the business dynamics. 
            <br />
            <br />
          </p>
          <p>
